    ...
    <ol class="list">
      <li v-for="(movie, i) in movies" :key="i">
        <a href="">
          ...
          <span class="desc">
            <i class="star"><b :style="{'width': calcBar(movie.score) + '%'}"></b></i>
...
.movie > ol > li i.star {
    width:71px; 
    height:14px; 
    background:url('../../images/icon_star.png') no-repeat 0 0/71px auto;
}
.movie > ol > li i.star > b {
    display:block; 
    width:0; 
    height:100%;
    background:url('../../images/icon_star.png') no-repeat 0 -15px/71px auto;
}
